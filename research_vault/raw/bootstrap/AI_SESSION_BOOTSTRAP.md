...
Version: v2.5.0
Updated: 2026-04-13
Status: ACTIVE - Think/do agentic model adopted. Conductor (GLM-5.1) + Reasoning Partner (Nemotron) + Workers (DeepSeek/Qwen). OpenFang bounded execution surface. Orchestration layer adopted.
...
- Agentic flow lock-in: `/home/evo/workspace/orchestration/_planning/AGENTIC_FLOW_LOCKIN_2026-04-13.md`
...
## Current Focus
- Think/do agentic model: GLM-5.1 conductor, Nemotron reasoning partner, DeepSeek/Qwen workers
- Conductor absorbs former General Manager role — no GM layer between conductor and PMs
- Orchestration layer is the agent communication hub (streams, tickets, role contracts)
- Memory and continuity through file-based persistent state, not agent session context
